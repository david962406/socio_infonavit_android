...
public class benevitsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /* intento de implementación MVVM, no funcionó debido a falta de tiempo e implementaciones, pero al llevarse a cabo asi de realizaría*/
        ...
        };//abrir el drawer menu al presionar las lineas de menú
        ...
        logout.setOnClickListener(new View.OnClickListener() {  // View.OnClickListener.
            ...
            }//  generar dialogo al salir de sesión
        });
        ...
        });//obteniendo las wallets de la base de datos de maner asincrona
        SharedPreferences preferences = getSharedPreferences("myPrefs", MODE_PRIVATE);//obteniendo el token JWT
        ...
        });//obteniendo los datos del landing para los benevit con el token como header
    }
